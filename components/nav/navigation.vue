  ...
  <div class="navbar bg-base-100 shadow max-w-full">
    ...
    <div class="navbar-end mr-4 gap-1">
      <details v-if="aiAvailable" class="hidden lg:block dropdown dropdown-bottom dropdown-end min-w-fit">
        ...
        <ai-dialog v-if="!aiModal" :its-dropdown="true" @change-screen="aiModal = true" class="text-sm dropdown-content bg-base-200 bg-opacity-70 backdrop-blur rounded-box z-50 w-96 min-h-96 max-h-screen p-2 shadow-xl"/>
      </details>
